...
class KategoriyaQoshishScreen extends StatefulWidget {
  const KategoriyaQoshishScreen({super.key});

  @override
  State<KategoriyaQoshishScreen> createState() => _KategoriyaQoshishScreenState();
}

class _KategoriyaQoshishScreenState extends State<KategoriyaQoshishScreen> {
  @override
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text('Qarz qo’shish',style: TextStyle(color: const Color(0xff2196f3),fontSize: 18.sp,fontWeight: FontWeight.w500),),
                    ),
                    const Divider(
                    ...
                    Padding(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Text('Mahsulot kodi',style: TextStyle(color: Color(0xff212121),fontSize: 16,fontWeight: FontWeight.w400)),
                          SizedBox(height:12.sp),
                          Container(
                              height: 44,
                              alignment: Alignment.center,
