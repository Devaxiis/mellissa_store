...
class QarzdorlikScreen extends StatelessWidget {
  const QarzdorlikScreen({super.key});
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: TextButton(
                                            ...
                                            child: const Text('Mijoz',style: TextStyle(color: Color(0xff616161),fontSize: 14,fontWeight: FontWeight.w400),)),
                                      ),
                                      const Padding(
                                        padding: EdgeInsets.symmetric(horizontal: 6),
                                        child: Text('Ta’minotchi',style: TextStyle(color: Color(0xff616161),fontSize: 14,fontWeight: FontWeight.w400),),
                                      ),
                                      const Padding(
                                        padding: EdgeInsets.symmetric(horizontal: 6),
                                        child: Text('Umumiy qarzdorlik',style: TextStyle(color: Color(0xff616161),fontSize: 14,fontWeight: FontWeight.w400),),
                                      ),
                                      const Padding(
                                        padding: EdgeInsets.symmetric(horizontal: 6),
                                        child: Text('Oldindan to\'lov',style: TextStyle(color: Color(0xff616161),fontSize: 14,fontWeight: FontWeight.w400),),
                                      ),
                                    ],
                                  )
                              ),
