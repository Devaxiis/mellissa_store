...
class QismanTolashView extends StatelessWidget {
  const QismanTolashView({super.key});
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text('Qisman to’lash',style: TextStyle(color: const Color(0xff2196f3),fontSize: 18.sp,fontWeight: FontWeight.w500),),
                    ),
                    const Divider(
