...
class MahsulotlarScreen extends StatelessWidget {
        ...
        floatingActionButton: SpeedDial(
          ...
          children: [
            SpeedDialChild(
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(builder: (_)=> const QarzQoshishScreen()));
                },
                label: "Qarz qoshish"),
            SpeedDialChild(
                labelStyle: const TextStyle(color: Colors.white),
            ...
            SpeedDialChild(
                ...
                labelBackgroundColor: const Color(0xff2196f3),
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(builder: (_)=> const MahsulotQoshishViewScreen()));
                },
